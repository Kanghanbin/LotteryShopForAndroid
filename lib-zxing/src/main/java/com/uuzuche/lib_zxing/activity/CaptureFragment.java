...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback,View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        openFlash= (Button) view.findViewById(R.id.openFlash);
    ...
    public void onClick(View v) {
         if(v.getId()==R.id.openFlash){
            if(openFlash.getText().toString().equals("开启闪光灯")){
                CodeUtils.isLightEnable(true);
                openFlash.setText("关闭闪光灯");
            }else {
                CodeUtils.isLightEnable(false);
                openFlash.setText("开启闪光灯");
            }
        }
    }
}
